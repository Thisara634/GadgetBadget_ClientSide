...
public class ProductApi extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String result = productObj.insertProduct(request.getParameter("ProductDate"),
				request.getParameter("ProductType"), request.getParameter("Description"),
				request.getParameter("ProductNumber"));
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String result = productObj.updateProduct(param.get("hidProductIDSave").toString(),
				param.get("ProductDate").toString().toString().replace("+", " "),
				param.get("ProductType").toString().toString().replace("+", " "),
				param.get("Description").toString().toString().replace("+", " "),
				param.get("ProductNumber").toString());
